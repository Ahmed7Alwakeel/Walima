...
const RecipeCardHome = (
    ...
    useEffect(() => {
        if (!!allRecipes && favorite) {
            const favItem = allRecipes.filter((recipe) => recipe.slug == cardSlug)
    ...
    return (
        <>
        {isMobile && 
            <motion.div className='recipe-card' initial={{ opacity: 0, y: index <= 1 ? 44 : 0 }} whileInView={{ opacity: 1, y: 0 }} viewport={{
                once: true,
                amount: recipeSearch  ? "" : bookmark?.05:.1
            }}
                transition=
                {{ duration: !isMobile?index<3?0.75:.4:.4, delay:!isMobile?index<3?parseFloat((index / 10) + 0.3):.05:0.05}}>
                ...
                <div className='card-items'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='card-info'>
                            ...
                            <p><img src='/img/like.png' alt='icon'/> {mainProduct}</p>
        ...
        {!isMobile && 
                    <motion.div className='recipe-card' initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{
                        once: true,
                        amount: recipeSearch  ? "" : bookmark?.05:.1
                    }}
                        transition=
